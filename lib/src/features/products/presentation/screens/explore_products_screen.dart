          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                ProductsSearchInput(brandId: brandId),
...
class ProductsSearchInput extends StatelessWidget {
  const ProductsSearchInput({super.key, required this.brandId});
  ...
  Widget build(BuildContext context) => SearchInputField(
    ...
    onChanged: (value) {
      context.read<ProductsCubit>().searchProductsWithDebounce(
        value,
        brandId: brandId,
      );
    },
...
class ProductsGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewBlocBuilder<ProductsCubit, Paginated<Product>>(
