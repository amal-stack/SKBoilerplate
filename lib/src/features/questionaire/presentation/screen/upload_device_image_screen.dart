...
class UploadDeviceImageScreen extends StatefulWidget {
  const UploadDeviceImageScreen({super.key});

  @override
  State<UploadDeviceImageScreen> createState() =>
      _UploadDeviceImageScreenState();
}

class _UploadDeviceImageScreenState extends State<UploadDeviceImageScreen> {
  File? frontImageFile;
  File? backImageFile;
  File? leftImageFile;
  File? rightImageFile;
      ...
      if (pickedFile != null) {
        setState(() {
          ...
          if (selectedIndex == 1) {
            ...
            rightImageFile = File(pickedFileDoc!.path);
          } else if (selectedIndex == 5) {
            topImageFile = File(pickedFileDoc!.path);
          } else if (selectedIndex == 6) {
            deviceBrokenFile = File(pickedFileDoc!.path);
          }
        });
      }
    } catch (e) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RegularText(
                        ...
                        textOverflow: TextOverflow.ellipsis,
                        text:
                            "Select the direction you wish to click image for",
                      ),
                            ...
                            child:
                                frontImageFile == null
                                    ? documentWidget(
                                      title: "Front",
                                      image:
                                          "assets/images/question/mobile_front.png",
                                      isFile: false,
                                    )
                                    : documentWidget(
                                      title: "Front",
                            ...
                            child:
                                backImageFile == null
                                    ? documentWidget(
                                      title: "Back",
                                      image:
                                          "assets/images/question/mobile_back.png",
                                      isFile: false,
                                    )
                                    : documentWidget(
                                      title: "Back",
                  ...
                  SizedBox(
                    ...
                    child: AnimatedButton(
                      ...
                      onPressed: () async {
                        ...
                        context.push('/device-value-screen');
                      },
